...
var ertdfgcvb = (function (t) {
  ...
  function f(t, e, n = {}) {
    return new Promise(function (o) {
      const r = { ...u, ...e, ...t.settings },
        a = { time: 0, frame: 0, cycle: 0 },
        s = "currentState";
      let i;
      ...
      const f = [],
        m = { x: 0, y: 0, pressed: !1, px: 0, py: 0, ppressed: !1 };
      var w;
      ...
      function N(e) {
        ...
        if (
          ...
          for (let t = 0; t < x.length; t++) x[t] = { ...y, char: " " };
        }
        if (
          ...
          for (let e = 0; e < h.rows; e++) {
            ...
            for (let r = 0; r < h.cols; r++) {
              const a = r + o,
                s = t.main({ x: r, y: e, index: a }, h, d, x, n);
              (x[a] =
  ...
  function g(t, e, n, o) {
    ...
    return Object.freeze({
      ...
      height: r.height,
      settings: e,
      runtime: Object.freeze({ cycle: t.cycle, fps: o.fps }),
    });
  }
  function p(t) {
  ...
  function S(t, e, n, o, r, a) {
    ...
    if (n < 0 || n >= a) return;
    const s = e + n * r,
      i = "object" == typeof o[s] ? o[s] : { char: o[s] };
    o[s] = { ...i, ...t };
  }
  ...
  function A(t, e, n, o, r, a) {
    ...
    return (
      s.split("\n").forEach((t, n) => {
        t.split("").forEach((t, n) => {
          (l = e + n), S({ char: t, ...i }, l, c, o, r, a);
        });
        const s = v(e, c, o, r, a),
          d = v(e + t.length - 1, c, o, r, a);
        h.push({ first: s, last: d }), c++;
      }),
      (c = Math.max(n, c - 1)),
      { offset: { col: l, row: c }, wrapInfo: h }
    );
  }
  function E(t, e = 0) {
    if (0 == e)
      return (function (t) {
        ...
        return { text: t, numLines: e, maxWidth: n };
      })(t);
    const n = t.split("\n");
    let o = "",
      r = 0,
  ...
  const lt = [
    ...
    ct = { a: at(160, 160, 160), b: at(135, 135, 135) },
    ht = { ...ct },
    dt = (function () {
      const t = 256,
        e = new Array(t),
    ...
    ut = { colorA: 0, colorB: 0, radiusSq: 0, movAmt: 0, scale: 0, data: [] },
  ...
  var yt = Object.freeze({
    ...
    boot: function (t, e, n) {
      ...
      for (let t = 0; t < o; t++) {
        const e = Math.floor(t / pt),
          n = t % pt;
        ut.data[t] = { fade: 0, heat: Math.floor(n / 4 + 2 * e) + 2, curr: 0 };
      }
    },
    pre: function (t, e, n, o) {
      ...
      if (
        ...
        (pt = t.cols), (mt = t.rows);
        const e = pt * mt;
        for (let t = 0; t < e; t++) ut.data[t] = { fade: 0, heat: 0, curr: 0 };
      }
    ...
    post: function (t, e, n, o) {
      ...
      for (const e of ft) {
        ...
        a.push({ x: o, y: l, displayMode: i, width: c });
      }
      for (const e of a)
        "rows" == e.displayMode
          ? k({ char: "─" }, e.x, e.y - 1, e.width, 1, ut.data, t.cols, t.rows)
          : "cols" == e.displayMode &&
            k({ char: "│" }, e.x - 1, 0, 1, s, ut.data, t.cols, t.rows);
  ...
  return (
    (t.boot = function (t) {
      ...
      f(yt, { element: e, fps: 30, allowSelect: !1 }, t),
