    ...
    <ul className="    p-0 m-0">
      ...
      >
        <div className="flex flex-col items-start  justify-center w-10/12 h-full">
          <h1
            className="text-white tracking-normal text-[11vw] md:text-[4.2vw] leading-none font-semibold"
      ...
      <li
        id="gallery-item-5"
        className="w-[100vw] md:w-[100vw] h-[100vh] md:h-[71vw] flex flex-col items-center justify-center  bg-[length:300%] md:bg-[length:120%]  bg-[left_60%_top_30%]  md:bg-[left_0%_top_45%] bg-no-repeat sticky -top-24"
        style={{
      ...
      <li
        id="gallery-item-6"
        className={`w-[100vw] md:w-[100vw] h-[100vh] md:h-[71vw]    flex flex-col items-center md:bg-cover bg-center bg-no-repeat sticky  top-0`}
        style={{
          backgroundColor: "#fff",
      ...
      <li
        id="gallery-item-7"
        className=" w-[100vw] md:w-[100vw] min-h-[100vh] md:h-[71vw]    md:flex flex-col  bg-[center_top_50%] md:bg-center bg-no-repeat bg-[length:400%] md:bg-[length:140%] md:bg-white "
        style={{
      ...
      <li
        ...
        className="md:hidden  w-[100vw] md:w-[100vw] h-[100vh] md:h-[71vw]  bg-[length:400%] md:bg-[length:130%_120%]  bg-[left_48%_top_0%] md:bg-[left_0%_top_10%] bg-no-repeat  -top-24"
        style={{
      ...
      <li
        ...
        className="md:hidden w-[100vw] md:w-[100vw] h-[100vh] md:h-[71vw]  bg-[length:200%]  bg-[left_45%_top_30%] md:bg-[left_0%_top_10%] bg-no-repeat  -top-24"
        style={{
      ...
      <li
        id="gallery-item-9"
        className="w-[100vw] md:w-[100vw] h-[100vh] md:h-[71vw]  flex flex-col items-center m-0 p-0 "
      >
        <div className="w-10/12">
          <p
            className=" relative top-[50vh] z-20 w-1/2  text-red md:text-black  text-[1.7rem] font-medium leading-none tracking-wide"
            style={{
              fontSize: "1.0rem" && "clamp(0.85rem, 1.07vw, 1.15rem)",
            }}
          >
        ...
        <div className="p-0 m-0 relative w-full h-full bg-white flex flex-col justify-start items-start">
          <iframe
            src="https://player.vimeo.com/video/840869673?h=0886893cd2&autoplay=1&loop=1&color=ffffff&title=0&byline=0&portrait=0"
            frameborder="0"
            autoPlay={true}
